...
- Key terminology
- 101 use cases (e.g. writing and querying using natural language, creating synthetic datasets, and interactive dashboards.)
- 201 use cases (e.g. creating a semantic view, creating Cortex Search services, building a Cortex Agent)
...
Please follow the instructions at our documentation to install Cortex Code

* [https://docs.snowflake.com/LIMITEDACCESS/cortex-code/cortex-code-overview](https://docs.snowflake.com/cortex-code/cortex-code-overview)	
